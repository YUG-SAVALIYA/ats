...
def evaluate_monthly_rsi_signal(
    ...
    # Use the most recent completed monthly candle as the signal candle
    ...
    # Determine swing low in daily candles over the window
    ...
    # Signal is generated at the end of the month, valid for next trading day
