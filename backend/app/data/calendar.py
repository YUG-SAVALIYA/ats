...
app.data.calendar
=================
Indian stock market calendar validation and trading day checks.
"""
...
from app.data.models import MarketHoliday
...
def is_trading_day(check_date: date = None) -> bool:
    """Returns True if the given date is a valid NSE/BSE trading day in India."""
